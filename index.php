<?php include('includes/header.php') ?>
					...
					<div class="rev_slider fullwidthabanner" id="rev_slider_one" data-version="5.4.1">
						<ul>
							...
							<li data-index="rs-1" data-transition="zoomout">
								<!-- MAIN IMAGE -->
								<img src="images/resource/float-img-4.png" alt="" class="rev-slidebg" />
								...
								>
									<span class="title">The Smart Exporter Logistics & Transport</span>
								</div>
								...
								<div
									...
									data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
								>
									<a href="index.php#about" class="theme-btn btn-style-one hvr-light"><span class="btn-title">Explore More</span></a>
								</div>
							</li>
							...
							<li data-index="rs-2" data-transition="zoomout">
								<!-- MAIN IMAGE -->
								<img src="images/resource/float-img-2.png" alt="" class="rev-slidebg" />
								...
								<div
									...
									data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
								>
									<span class="title">Smart Exporter Logistics & Transport</span>
								</div>
								...
								<div
									...
									data-frames='[{"delay":1000,"speed":1500,"frame":"0","from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
								>
									<h2>Exportation & <br />Procurement</h2>
								</div>
			...
			<section class="features-section">
				<div class="auto-container">
					<div class="row">
						<!-- Feature Block 1-->
						<div class="feature-block col-lg-4 col-md-6 col-sm-6">
							<div class="inner-box">
								<div class="icon-box">
								...
								<div class="content-box">
									...
									<div class="text">We offer one of the best and flexible payment plans.</div>
								</div>
							</div>
						</div>
						...
						<div class="feature-block col-lg-4 col-md-6 col-sm-6">
							<div class="inner-box">
								...
								<div class="content-box">
									...
									<div class="text">Timely deliveriy is our priority.</div>
								</div>
							</div>
						</div>
						...
						<div class="feature-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								...
								<div class="content-box">
									...
									<div class="text">Expensive network of warehouse globally.</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
							<div class="inner-column">
								<div class="sec-title">
									<span class="sub-title">Cargo & Export Company</span>
									<h2>Logistics, Export & Procurement services</h2>
									<div class="text">
										Our services extends to Exportation & Procurement for Individuals, companies and African stores in Diaspora . 
										Procurement of wholesales goods for brands both home and abroad can be handled seamlessly.
									</div>
								</div>
								...
								<div class="content-box">
									<div class="about-block">
										...
										<p class="text">We’re a key player in the logistic sector ranging from fright, sea, and land.</p>
									</div>

									<div class="about-block">
										<i class="icon flaticon-3d-cube"></i>
										<h4 class="title">Procurement & White Labeling</h4>
										<p class="text">
											We strive to maximize customer value by procuring quality nigerian indigenous products at great 
											prices with global standard packaging that will exceed customers expectations.
										</p>
									</div>
								</div>
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<figure class="image-1"><img src="images/resource/truck.png" alt="" /></figure>
								<figure class="image-2"><img src="images/resource/float-img-1.png" alt="" /></figure>
								<div class="experience">
									<strong
										><i class="icon flaticon-global"></i> 6+<br />
										Years</strong
									>
									Working Exprience
								</div>
			...
			<section class="services-section">
				...
				<div class="auto-container">
					...
					<div class="row">
						<!-- Service Block -->
						<div class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp">
							<div class="inner-box">
								<div class="image-box">
									<figure class="image">
										<a href="page-service-details.html"><img src="https://via.placeholder.com/270x190" alt="" /></a>
									</figure>
								</div>
								<div class="content-box">
									...
									<div class="text">We offer Air fright cargo services </div>
								</div>
							</div>
						</div>

						<!-- Service Block -->
						<div class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="300ms">
							<div class="inner-box">
								<div class="image-box">
									<figure class="image">
										<a href="page-service-details.html"><img src="https://via.placeholder.com/270x190" alt="" /></a>
								...
								<div class="content-box">
									...
									<div class="text">our service include sea cargo</div>
								</div>
							</div>
						</div>

						<!-- Service Block -->
						<div class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="600ms">
							<div class="inner-box">
								<div class="image-box">
									<figure class="image">
										<a href="page-service-details.html"><img src="https://via.placeholder.com/270x190" alt="" /></a>
								...
								<div class="content-box">
									...
									<h4 class="title"><a href="page-service-details.html">Procurement</a></h4>
									<div class="text">Product Procurement for diasporal's</div>
								</div>
							</div>
						</div>

						<!-- Service Block -->
						<div class="service-block col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="900ms">
							<div class="inner-box">
								<div class="image-box">
									<figure class="image">
										<a href="page-service-details.html"><img src="https://via.placeholder.com/270x190" alt="" /></a>
								...
								<div class="content-box">
									...
									<h4 class="title"><a href="page-service-details.html">Warehouse</a></h4>
									<div class="text">Extensive network of storage and warehouse</div>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- Tracking Section -->
			<section id="track" class="tracking-section pull-down">
				<div class="auto-container">
					<div class="outer-box">
							...
							<form method="post" action="track.php">
								<div class="row">
									<div class="form-group col-lg-8 col-md-8 col-sm-12">
										...
										<input type="text" name="tracking_code" placeholder="Input Your Tracking ID" />
									</div>
									<!-- Form Group -->
									...
									<!-- Form Group -->
									<div class="form-group col-lg-4 col-md-4 col-sm-12 text-end">
			...
			<!-- <section class="call-to-action" style="background-image: url(./images/background/2.jpg)">
				<div class="auto-container">
					<div class="outer-box">
						<a href="https://www.youtube.com/watch?v=Fvae8nxzVz4" class="play-now lightbox-image"><i class="icon fa fa-play"></i><span class="ripple"></span></a>
						<div class="sec-title light mb-0">
							...
							<a href="page-services.html" class="theme-btn btn-style-one hvr-light"><span class="btn-title">Get A Quote</span></a>
						</div>
					</div>
				</div>
			</section> -->
			...
			<section class="work-section">
				...
				<div class="auto-container">
					...
					<div class="row">
						<!-- Work Block -->
						<div class="work-block col-lg-4 col-md-6 col-sm-6 wow fadeInRight">
							<div class="inner-box">
								<div class="icon-box">
									<span class="count">01</span>
									<i class="icon flaticon-delivery-box-4"></i>
						...
						<!-- Work Block -->
						<div class="work-block col-lg-4 col-md-6 col-sm-6 wow fadeInRight" data-wow-delay="300ms">
							<div class="inner-box">
								<div class="icon-box">
									<span class="count">02</span>
					...
					<div class="outer-box">
						...
						<div class="row">
							...
							<div class="content-column col-lg-7 col-md-12 col-sm-12 order-2">
								<div class="inner-column">
									<div class="sec-title light">
										...
										<h2>Total Coverage & Flexibility in Exports & Logistics</h2>
										<div class="text">
											With services to over 150 countries worldwide, we have the resources and expertise
											to facilitate your international shipment and make the delivery as simple as possible.
										</div>
									</div>
									...
									<div class="fact-counter">
										<div class="row">
											...
											<!--Column-->
											<div class="counter-column col-lg-4 col-md-6 col-sm-6">
												<div class="inner">
							...
							<div class="image-column col-lg-5 col-md-12 col-sm-12">
								<div class="inner-column">
									<figure class="image"><img src="images/resource/float-img-3.png" alt="" /></figure>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="why-choose-us pull-up pb-0">
				...
				<div class="anim-icons">
					<!-- <div class="float-image"><img src="images/resource/float-img-4.png" alt="" /></div> -->
				</div>
				...
				<div class="auto-container">
					<div class="row">
							...
							<div class="inner-column">
								...
								<div class="feature-block-two">
									<div class="inner-box">
										...
										<p class="text">We specialize in delivering exceptional, relationship-based service.</p>
									</div>
								</div>
							</div>
						</div>
						...
						<!-- Quote Column -->
						<div id="quote" class="form-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<!-- Contact Form -->
			...
			<section class="about-section-two">
				<div class="auto-container">
					<div class="row">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<figure class="image-1 wow fadeInUp"><img src="https://via.placeholder.com/490x586" alt="" /></figure>
								<figure class="image-2 wow fadeInRight">
									<img src="https://via.placeholder.com/390x380" alt="" />
				...
				<div class="auto-container">
					<div class="row">
						...
						<div class="image-column col-lg-7 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image-box">
									<figure class="image"><img src="https://via.placeholder.com/505x685" alt="" /></figure>
									<figure class="image"><img src="https://via.placeholder.com/505x685" alt="" /></figure>
					...
					<div class="row">
						...
						<div class="news-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								<div class="image-box">
									<figure class="image">
										<a href="news-details.html"><img src="https://via.placeholder.com/370x270" alt="" /></a>
									</figure>
								...
								<div class="lower-content">
									...
									<h4 class="title"><a href="news-details.html">We very careful handling the valuable goods</a></h4>
						...
						<div class="news-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h4 class="title"><a href="news-details.html">Why is supply chain visibility so important?</a></h4>
									<a href="news-details.html" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
								</div>
							</div>
						</div>
						...
						<div class="news-block col-lg-4 col-md-6 col-sm-12">
							<div class="inner-box">
								...
								<div class="lower-content">
									...
									<h4 class="title"><a href="news-details.html">Cargo flow through better supply in UK</a></h4>
									<a href="news-details.html" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
								</div>
							</div>
						</div>
